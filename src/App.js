    ...
    return (
        <div className="App">
            ...
            <div className="layout-row align-items-center justify-content-center my-20 navigation">
                ...
                <button onClick={()=>handleChange(0)} data-testid="most-upvoted-link" className="small">Most Upvoted</button>
                <button onClick={()=>handleChange(1)} data-testid="most-recent-link" className="small">Most Recent</button>
            </div>
